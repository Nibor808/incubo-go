...
type ContactFormProps = {
    ...
    onChange: (ev: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, name: string) => void;
    errors: Errors;
            ...
            <div className="col-sm-8 col-lg-6">
                <form onSubmit={sendMail} method="post" id="contact-form">
                    ...
                    <div className="mb-3">
                        ...
                        />
                        <small>Your information will never be stored nor shared. Full stop.</small>
                    </div>
